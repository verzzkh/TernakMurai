<aside class="w-64 bg-white dark:bg-gray-850 border-r border-gray-200 dark:border-gray-800 hidden md:flex flex-col">
    ...
    <div class="px-6 py-4 border-t border-gray-100 dark:border-gray-800">
        ...
        <a href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" class="block px-3 py-2 text-sm text-red-600 hover:bg-red-50 rounded-md">Logout</a>
    </div>
</aside>
