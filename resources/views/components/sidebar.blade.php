<aside class="flex-shrink-0 hidden w-64 bg-white border-r dark:border-primary-darker dark:bg-darker md:block" id="sidebar">
    <div class="flex flex-col h-full">
        ...
        <div class="flex items-center justify-between px-4 py-3 border-b dark:border-primary-darker">
            <div class="flex items-center">
                ...
                <span class="ml-2 text-lg font-semibold text-gray-700 dark:text-light">Murai Batu</span>
            </div>
            <button id="toggle-sidebar-mobile" class="md:hidden p-2 rounded-md text-gray-700 dark:text-light hover:bg-gray-100 dark:hover:bg-primary-dark">
        ...
        <div class="flex items-center px-4 py-3 border-b dark:border-primary-darker">
            <div class="w-10 h-10 overflow-hidden rounded-full bg-gray-200 dark:bg-primary-darker flex items-center justify-center">
                <svg class="w-6 h-6 text-gray-500 dark:text-primary-light" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
            </div>
            <div class="ml-3">
                <h4 class="text-sm font-semibold text-gray-700 dark:text-light">Pak Murai</h4>
                <p class="text-xs text-gray-500 dark:text-primary-light">Administrator</p>
            </div>
        </div>
        ...
        <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
            ...
            <a href="{{ route('peternak.kandang.index') }}"
                ...
                <span class="ml-auto bg-primary-100 text-primary-dark dark:bg-primary dark:text-primary-100 px-2 py-0.5 rounded-full text-xs">5</span>
            </a>
        ...
        <div class="flex-shrink-0 px-2 py-4 space-y-2">
            <div class="flex items-center justify-between px-2 py-2 text-sm text-gray-600 dark:text-light">
                <span>Dark Mode</span>
                <button id="theme-toggle" class="relative inline-flex items-center w-10 h-5 rounded-full bg-gray-200 dark:bg-primary-dark focus:outline-none">
                    <span class="absolute w-4 h-4 transition-transform duration-300 transform bg-white rounded-full translate-x-0.5 dark:translate-x-5"></span>
                </button>
            </div>
