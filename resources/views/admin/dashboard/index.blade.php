<x-admin.layout title="Dashboard">
    <div class="mt-2">
        ...
        <div class="grid grid-cols-1 gap-6 p-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <!-- Total User -->
            <div
                class="group flex items-center justify-between p-5 bg-white rounded-xl shadow-md dark:bg-darker transition-all hover:-translate-y-1 hover:shadow-lg">
                <div>
                    <p class="text-xs font-semibold tracking-wide text-gray-500 uppercase dark:text-primary-light">Total
                        User</p>
                ...
                <div class="flex items-center justify-center w-14 h-14 rounded-full bg-indigo-50 dark:bg-indigo-900/30">
                    <svg class="w-8 h-8 text-indigo-600 dark:text-indigo-300" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M16 11c1.657 0 3-1.567 3-3.5S17.657 4 16 4s-3 1.567-3 3.5S14.343 11 16 11zM8 22v-2a4 4 0 014-4h0a4 4 0 014 4v2" />
                    </svg>
                </div>
            </div>
            ...
            <div
                class="group flex items-center justify-between p-5 bg-white rounded-xl shadow-md dark:bg-darker transition-all hover:-translate-y-1 hover:shadow-lg">
                <div>
                    <p class="text-xs font-semibold tracking-wide text-gray-500 uppercase dark:text-primary-light">User
                        PRO</p>
                ...
                <div class="flex items-center justify-center w-14 h-14 rounded-full bg-green-50 dark:bg-green-900/30">
                    <svg class="w-8 h-8 text-green-600 dark:text-green-300" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
            ...
            <div
                ...
                <div class="flex items-center justify-center w-14 h-14 rounded-full bg-blue-50 dark:bg-blue-900/30">
                    <svg class="w-8 h-8 text-blue-600 dark:text-blue-300" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div
                ...
                <div class="flex items-center justify-center w-14 h-14 rounded-full bg-sky-50 dark:bg-sky-900/30">
                    <svg class="w-8 h-8 text-sky-600 dark:text-sky-300" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div
                ...
                <div class="flex items-center justify-center w-14 h-14 rounded-full bg-purple-50 dark:bg-purple-900/30">
                    <svg class="w-8 h-8 text-purple-600 dark:text-purple-300" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 3v4m0 0a4 4 0 100 8m0-8a4 4 0 110 8m0 4v-4" />
                    </svg>
                </div>
            </div>
                        ...
                        <li class="p-4 flex justify-between items-center">
                            <div>
                                ...
                                <div class="text-xs text-gray-500">
                                    {{ \Illuminate\Support\Str::limit(strip_tags($d->hasil_ai ?? ''), 80) }}</div>
                            </div>
                            <div class="text-xs text-gray-400">{{ optional($d->tanggal_analisa)->format('d M Y') }}
                            </div>
                        </li>
                    @empty
