...
class DeteksiPenyakitController extends Controller
{
    ...
    public function process(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('deteksi-penyakit.result');
            ...
            // Handle exceptions
            return redirect()->route('deteksi-penyakit.index')
    ...
    public function result()
    {
        ...
        return view('hasil-deteksi-penyakit', compact('result'));
    }
}